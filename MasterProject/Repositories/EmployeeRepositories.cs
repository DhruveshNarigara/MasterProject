...
namespace MasterProject.Repositories
{
    public class EmployeeRepositories : CommanRepositories, IEmployeeRepositories
    {
        public IEnumerable<EmployeeModel> GetAllEmployees()
        {
            ...
            string sql = "SELECT c_empid, c_uid, c_empname, c_empgender, c_empdob, c_empshift, c_empdept, c_empimage FROM t_employeemaster";
        ...
        public EmployeeModel GetEmployeeById(int id)
        {
            ...
            string sql = "SELECT c_empid, c_uid, c_empname, c_empgender, c_empdob, c_empshift, c_empdept, c_empimage FROM t_employeemaster WHERE c_empid = @id";
